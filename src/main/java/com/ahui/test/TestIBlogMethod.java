...
public class TestIBlogMethod {
    ...
    public void findBlogByID(){
        Blog blog = blogDao.findBlogByID(1);
        System.out.println(blog);
    }

    @Test
    public void findBlogById2(){
        Blog blog = blogService.findBlogByID(1);
        System.out.println(blog);
    }

    @Test
    public void findBlogByID3(){
